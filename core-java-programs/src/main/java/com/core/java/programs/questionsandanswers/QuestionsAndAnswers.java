...
public class QuestionsAndAnswers {
    ...
    * 11. What is constructor calling in java
   ...
   * */
    ...
    /*
    * SQL :
    * 1. Can you please write down a sql query to get a 'nth' the highest salary from an Employee table?
